...
-- NOTE: The optional exam_categories table (managed category suggestions)
-- lives in database/migration_flexible_categories.sql — import that file
-- to enable the managed category list. It is NOT required: category columns
-- are free-form VARCHAR, and get_exam_categories() falls back to a default
-- list plus any categories already used in your data.
